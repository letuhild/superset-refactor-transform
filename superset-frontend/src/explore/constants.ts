...
export const AGGREGATES_OPTIONS = {
  AVG: 'AVG 平均值',
  COUNT: 'COUNT 计数',
  COUNT_DISTINCT: 'COUNT_DISTINCT 唯一计数',
  MAX: 'MAX 最大值',
  MIN: 'MIN 最小值',
  SUM: 'SUM 求和',
};;
...
export const OPERATOR_ENUM_TO_OPERATOR_TYPE: {
  ...
  [Operators.EQUALS]: { display: '相等', operation: '==' },
  [Operators.NOT_EQUALS]: { display: '不相等', operation: '!=' },
  [Operators.GREATER_THAN]: { display: '>', operation: '>' },
  [Operators.LESS_THAN]: { display: '<', operation: '<' },
  [Operators.GREATER_THAN_OR_EQUAL]: { display: '>=', operation: '>=' },
  [Operators.LESS_THAN_OR_EQUAL]: { display: '<=', operation: '<=' },
  [Operators.IN]: { display: '包含', operation: 'IN' },
  [Operators.NOT_IN]: { display: '不包含', operation: 'NOT IN' },
  [Operators.LIKE]: { display: '相似', operation: 'LIKE' },
  [Operators.ILIKE]: { display: '相似 (不分大小写)', operation: 'ILIKE' },
  [Operators.REGEX]: { display: '正则表达式', operation: 'REGEX' },
  [Operators.IS_NOT_NULL]: { display: '非空', operation: 'IS NOT NULL' },
  [Operators.IS_NULL]: { display: '空', operation: 'IS NULL' },
  [Operators.LATEST_PARTITION]: {
    display: 'use latest_partition template',
    operation: 'LATEST PARTITION',
  },
